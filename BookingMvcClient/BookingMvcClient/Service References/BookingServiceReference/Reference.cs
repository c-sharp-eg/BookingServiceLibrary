...
namespace BookingMvcClient.BookingServiceReference {
    ...
    public interface IBooking {
        ...
        bool MakeBooking(BookingMvcClient.BookingServiceReference.BookingData data);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBooking/MakeBooking", ReplyAction="http://tempuri.org/IBooking/MakeBookingResponse")]
        System.Threading.Tasks.Task<bool> MakeBookingAsync(BookingMvcClient.BookingServiceReference.BookingData data);
        ...
        System.Collections.Generic.List<BookingMvcClient.BookingServiceReference.BookingData> ViewBookingsFrom(System.DateTime when);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBooking/ViewBookingsFrom", ReplyAction="http://tempuri.org/IBooking/ViewBookingsFromResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<BookingMvcClient.BookingServiceReference.BookingData>> ViewBookingsFromAsync(System.DateTime when);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBookingChannel : BookingMvcClient.BookingServiceReference.IBooking, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BookingClient : System.ServiceModel.ClientBase<BookingMvcClient.BookingServiceReference.IBooking>, BookingMvcClient.BookingServiceReference.IBooking {
        ...
        public bool MakeBooking(BookingMvcClient.BookingServiceReference.BookingData data) {
            return base.Channel.MakeBooking(data);
        }
        
        public System.Threading.Tasks.Task<bool> MakeBookingAsync(BookingMvcClient.BookingServiceReference.BookingData data) {
            return base.Channel.MakeBookingAsync(data);
        }
        
        public System.Collections.Generic.List<BookingMvcClient.BookingServiceReference.BookingData> ViewBookingsFrom(System.DateTime when) {
            return base.Channel.ViewBookingsFrom(when);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<BookingMvcClient.BookingServiceReference.BookingData>> ViewBookingsFromAsync(System.DateTime when) {
